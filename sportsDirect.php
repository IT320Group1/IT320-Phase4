...
if (isset($_POST['submit'])) { 
	...
	$comment = $_POST['comment']; 
        ...
        $filename = $_FILES['files']['name'];
          ...
          $sql2= "INSERT INTO review (id, website_name ,comment,image,name) VALUES ('$rid','sportsDirect','$comment', '$filename', '$name')";
...
<li><a href="#news" style=" font-weight: 900;"><pre>THE COMFORT ZONE    </pre></a></li>
 ...
 <li class = 'link'><a class="active" href="sportsDirect.php">Item</a></li>
...
<div class="bg bg3"></div>  
        ...
        <main>
            <h1>Sports Direct</h1>
            <img src="SportsDirect.jpeg" alt="sports direct logo" id="websitelogo">
            <p>Established in 1982 by Mike Ashley, the company is the United Kingdom's
                largest sports-goods retailer and operates roughly 670 stores worldwide.
                The company's business model is one that operates under low margins.
                Mike Ashley has continued to hold a majority stake in the business, 
                and his holding has been 61.7 percent since October 2013.
                It is listed on the London Stock Exchange and it is a constituent of the FTSE 250 Index.</p>
		...
		<div class="prev-comments">
			...
			include 'config.php';
                        //webnname
			$sql = "SELECT * FROM review WHERE website_name = 'sportsDirect'";
