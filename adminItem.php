...
hr {
  ...
  border-width: 1px;
    ...
    function confirmDesactiv(x)
    {
       var flag = confirm("Are you sure you want to delete this item ?");
       if(flag)
          window.open("deleteItem.php?id="+x);
...
<li><a href="#news" style=" font-weight: 900;"><pre>THE COMFORT ZONE    </pre></a></li>
 ...
 <li class = 'link'><a class="active" <?php echo "href='adminItem.php?id=$id'";?> >Item</a></li>
...
<div class='centerButton'>
           ...
           <?php echo ' <button type="button" class="rightbuttons" onclick="location.href=\'update.php?id='.$id.'\';">Update</button> ';?>
           <?php echo ' <button type="button" class="rightbuttons" onclick="confirmDesactiv('.$id.')">Delete</button> ';?>
 </div> 
        <main>
            <h1><?php echo $row['website_name']; ?></h1>
             <?php echo '<img class="reviewimage" src="upload/'.$row["website_image"].'" alt="websitelogo" id="websitelogo">'; ?> 
