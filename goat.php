...
if (isset($_POST['submit'])) { 
	...
	$comment = $_POST['comment']; 
        ...
        $filename = $_FILES['files']['name'];
          ...
          $sql2= "INSERT INTO review (id, website_name ,comment,image,name) VALUES ('$rid','goat','$comment', '$filename', '$name')";
...
<li><a href="#news" style=" font-weight: 900;"><pre>THE COMFORT ZONE    </pre></a></li>
 ...
 <li class = 'link'><a class="active" href="goat.php">Item</a></li>
...
<div class="bg bg3"></div>  
        ...
        <main>
            ...
            <h1>Goat</h1>
            <img src="goat-logo-.png" alt="goatlogo" id="websitelogo">
            <p>GOAT is the global platform for style. Founded in 2015 to bring trust to the sneaker
                community, the technology platform has since expanded to offer apparel and accessories 
                from the world’s leading contemporary, avant garde and luxury brands. Through its unique
                positioning between the primary and resale markets, the company is able to surface styles 
                from the past, present and future, delivering authentic product to over 20M members across
                164 countries.</p>
		...
		<div class="prev-comments">
			...
			include 'config.php';
                        //webnname
			$sql = "SELECT * FROM review WHERE website_name = 'goat'";
